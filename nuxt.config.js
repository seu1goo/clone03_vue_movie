export default {
  ...
  head: {
    ...
    meta: [
      ...
      {hid: 'og:title', property: 'og:title', content: 'Nuxt OMDbAPI / Search'},
      ...
      {hid: 'og:image', property: 'og:image', content: 'https://raw.githubusercontent.com/seu1goo/vue-movie-app/master/src/assets/movie.jpg'},
